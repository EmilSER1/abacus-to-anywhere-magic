...
export default function ProjectorDepartmentDisplay({ 
  ...
  const roomsData = useProjectorDepartmentRooms(departmentName)  // departmentName здесь - название отделения проектировщиков
         ...
         <div className="space-y-2">
           {Object.keys(roomsData).length === 0 ? (
             <div className="text-sm text-muted-foreground italic p-2 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded">
               ...
               <br />
               <span className="text-xs">Проверьте данные проектировщиков в базе</span>
             </div>
           ) : (
